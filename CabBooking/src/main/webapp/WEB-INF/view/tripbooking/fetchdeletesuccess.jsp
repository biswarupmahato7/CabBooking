...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">    <h1 style="padding-bottom:20px; text-align:center"><b class="fa fa-align-center" aria-hidden="true">Trip details</b></h1>
    <form:form action="deletetrip" modelAttribute="trip" method="post">
        <form:hidden path="tripBookingId" value="${trip.tripBookingId}"/>
        <div class="form-group">
          <label for="tripBooking.customer">CustomerId</label>
          <form:input path="tripBooking.customer" value="${tripbooking.customer.customerId}"
