...
<body class="sub_page">
  ...
  <div class="container text-center" style= "background-color:white; margin: auto; padding-top: 50px; margin-bottom: 50px;">        <h1 class="fa fa-align-center" aria-hidden="true">Count of  ${cab.carType}</h1> 
