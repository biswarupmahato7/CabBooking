...
<body class="sub_page">
  ...
  <div class="container" style= "background-color:white; margin: auto; padding-top: 50px; width:600px; margin-bottom: 50px;">		<form:form action="countcabtypes" modelAttribute="cab" method="post">
